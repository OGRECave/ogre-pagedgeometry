...
mFadeInvisibleDist      (0.f)
{
   ...
   if (mRenderMethod == BB_METHOD_ACCELERATED)
   {
      ...
      if (s_nSelfInstances == 0)
      {
		 ...
		 HighLevelGpuProgramPtr vertexShader = Ogre::static_pointer_cast<HighLevelGpuProgram>(HighLevelGpuProgramManager::getSingleton().getByName("Sprite_vp"));
		 ...
		 HighLevelGpuProgramPtr vertexShader2 = Ogre::static_pointer_cast<HighLevelGpuProgram>(HighLevelGpuProgramManager::getSingleton().getByName("SpriteFade_vp"));
